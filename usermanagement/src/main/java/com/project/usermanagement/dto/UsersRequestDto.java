...
public class UsersRequestDto {
	...
	@Override
	public int hashCode() {
		return Objects.hash(address, dob, dpUrl, email, gender, mobile, password, username);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && Objects.equals(dob, other.dob)
				&& Objects.equals(dpUrl, other.dpUrl) && Objects.equals(email, other.email) && gender == other.gender
